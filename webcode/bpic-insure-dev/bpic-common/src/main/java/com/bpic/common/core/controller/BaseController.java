package com.bpic.common.core.controller;
...
import com.bpic.common.core.page.PageDomain;
import com.bpic.common.core.page.TableDataInfo;
import com.bpic.common.core.page.TableSupport;
import com.bpic.common.utils.DateUtils;
import com.bpic.common.utils.sql.SqlUtil;
...
public class BaseController
{
    ...
    protected TableDataInfo getDataTable(List<?> list,List<?> list1)
    {
        ...
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
        rspData.setRows(list);//查询后的封装数据
        rspData.setTotal(new PageInfo(list1).getTotal());//查询后分页数据
        return rspData;
    }
