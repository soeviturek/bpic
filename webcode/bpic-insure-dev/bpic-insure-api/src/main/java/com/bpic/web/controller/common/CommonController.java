package com.bpic.web.controller.common;
...
import com.bpic.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = BpicConfig.getDownloadPath() + fileName;
    ...
    {
        // 本地资源路径
        String localPath = BpicConfig.getProfile();
        // 数据库资源地址
