...
import com.bpic.common.core.domain.entity.SysDictType;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    @Override
    public Response<Map<String, List<DictVo>> > findByCodes(String codes) {
            ...
            Map<String, List<DictVo>> dicts = new HashMap<String, List<DictVo>>();
            try {
                for (int i = 0; i < array_codes.length; i++) {
                    Date start1 = new Date();
                    List<DictVo> dictList = dictDataMapper.selectDictVoList(array_codes[i]);
                    Date end1 = new Date();
