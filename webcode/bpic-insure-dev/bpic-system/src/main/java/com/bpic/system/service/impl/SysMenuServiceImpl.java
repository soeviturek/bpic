...
import com.bpic.system.domain.vo.MetaVo;
import com.bpic.system.domain.vo.RouterVo;
import com.bpic.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, String userId)
    {
        ...
        // 管理员显示所有菜单信息
        if (sysUserService.selectRoleKey(userId))
        {
    ...
    public List<SysMenu> selectMenuTreeByUserId(String userId)
    {
        ...
        Long admin = userMapper.isAdmin(Long.parseLong(userId));
